            ...
            for(int i = 0;i<jsonArray.length(); i++){
                ...
                try {
                    ...
                    emailList.add(new Email(o.getInt(Constants.EMAILID), o.getString(Constants.HEADER), o.getString(Constants.DESCRIPTION),
                            java.sql.Timestamp.valueOf(o.getString(Constants.TIMEEVENTOCCURED)), o.getString(Constants.STATUS),  o.getInt(Constants.APPLICATION), o.getInt(Constants.USERID)));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
